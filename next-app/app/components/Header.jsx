    ...
    <header className="relative z-40 h-[72px] border-b border-[var(--line)] bg-[var(--bg)] transition-colors">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[26px] sm:text-[28px] leading-[34px] font-[500] tracking-[-0.02em] text-[var(--fg)] select-none">
            Mara
          </span>
          <span className="hidden sm:inline-flex items-center px-2 py-0.5 rounded text-[11px] font-mono font-medium text-[var(--fg-3)] bg-[var(--fill-1)] border border-[var(--line)] select-none">
            AFM 692k
          </span>
        </div>
        ...
        <div className="flex items-center space-x-3 sm:space-x-5 text-[13px] leading-[18px] text-[var(--fg-2)] font-normal">
          ...
          <div className="h-4 w-[1px] bg-[var(--line)] hidden md:block" />

          {/* Action Group: HF, GitHub & Theme */}
          <div className="flex items-center gap-2">
            ...
            >
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                className="transition-all duration-250 ease-out group-hover:scale-115 group-hover:-translate-y-0.5 motion-reduce:transform-none"
              >
